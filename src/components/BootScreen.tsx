...
const bootSequence: BootLine[] = [
  ...
  { text: "[BOOT] Initializing kernel modules...", delay: 250, type: "system" },
  { text: "[  OK  ] Cipher modules loaded", delay: 450, type: "success" },
  { text: "[BOOT] Establishing secure channel...", delay: 600, type: "system" },
  { text: "[  OK  ] TLS 1.3 handshake complete", delay: 800, type: "success" },
  { text: "", delay: 900, type: "system" },
  { text: "[AUTH] Verifying access credentials...", delay: 1000, type: "warning" },
  { text: "[  OK  ] Identity matrix validated", delay: 1200, type: "success" },
  { text: "", delay: 1300, type: "system" },
  { text: "[VAULT] Decrypting challenge archives...", delay: 1400, type: "system" },
  { text: "[  OK  ] 47 challenges unlocked", delay: 1600, type: "success" },
  { text: "", delay: 1700, type: "system" },
  { text: "[NET] Synchronizing with NOVUS mainframe...", delay: 1800, type: "system" },
  { text: "[  OK  ] Connection established", delay: 2000, type: "success" },
  { text: "", delay: 2100, type: "system" },
  { text: "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━", delay: 2200, type: "system" },
  { text: "", delay: 2300, type: "system" },
  { text: "ACCESS GRANTED", delay: 2400, type: "header" },
  { text: "Welcome to the NOVUS CTF Platform", delay: 2600, type: "system" },
  { text: "Redirecting to authentication portal...", delay: 2800, type: "warning" },
];
